...
/*
* 5 CSRT Program w/ One Port
* JHL, 11/28/18
*
* Components: 1 IR / 1 LED / 1 solenoid
* Run types 1 and 2 added 
*
* Program Description:
* 0. Program Starts after 2 seconds of delay
* 1. LED turns on
* 2. If 3 head pokes registered within LED_on_duration, (5s)
* 3. solenoid reward is given
* 4. Resets ITI after solenoid turns off
*
* 2.b If not 3 head pokes,
* 4.b Resets ITI right away
* 1. LED turns on again
*

* * Future Implementations *
* 1. punishment instead of no reward? (don't reset ITI right away)
* 2. Random sampling from ITI list
*
*/
